...
// Google Apps Script Web App URL (환경변수에서 로드)
const GAS_API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://script.google.com/macros/s/AKfycbzHoHPB_K04YxcOF-ANWzfx9WSHwI-1FetStmpRJBoILTY6Xi6uwaVrQaBSsOCE4Fee/exec';
